...
```
/data/
├── kz_business.json          # Казахстанские бизнесы (5 компаний)
├── ru_business.json          # Российские бизнесы (пусто, готово к расширению)
└── seo_services.json         # SEO и цифровые услуги (пусто, готово к расширению)
...
- **kz_business.json**: 5 бизнесов из Казахстана
- **ru_business.json**: Подготовлена для расширения
- **seo_services.json**: Подготовлена для расширения
...
1. **Добавление новых регионов**:
   - Россия → `ru_business.json`
   - Другие страны → `<country>_business.json`
...
1. Заполнить `ru_business.json` российскими бизнесами
2. Добавить SEO-компании в `seo_services.json`
3. Создать специализированные файлы для других категорий
4. Интегрировать с RAG системой
5. Добавить векторные эмбеддинги для семантического поиска
